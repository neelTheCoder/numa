...
# Configuration
bdf_file = '/Volumes/Extreme SSD/ds004514-download/sub-12/eeg/sub-12_task-eeg_eeg.bdf'  # Your BDF file
events_file = '/Volumes/Extreme SSD/cleaned events files/sub12cleaned.tsv'  # Your cleaned events file
output_file = '/Volumes/Extreme SSD/cleaned EEG trials/sub12EEGTrials.csv'  # Output file

print("Loading BDF file...")
# Read the BDF file using MNE
